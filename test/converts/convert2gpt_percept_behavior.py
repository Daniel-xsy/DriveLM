...
def convert_to_gpt_format(input_file, output_file):
    ...
    for scene_id, scene_content in data.items():
        ...
        for frame_id, frame_content in key_frames.items():
            ...
            qa_categories = ['perception', 'behavior']
...
if __name__ == '__main__':
    input_file = '/mnt/workspace/models/DriveLM/data/QA_dataset_nus/drivelm_val_norm_final.json'  # Update with your actual input file path
    output_file = '/mnt/workspace/models/DriveLM/data/test/test_gpt_norm_final_p1p4.json'
